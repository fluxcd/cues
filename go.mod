...
require (
	...
	github.com/fluxcd/kustomize-controller/api v0.34.0 // indirect
	github.com/fluxcd/notification-controller/api v0.32.0 // indirect
	github.com/fluxcd/pkg/apis/acl v0.1.0 // indirect
	github.com/fluxcd/pkg/apis/kustomize v0.8.0 // indirect
	github.com/fluxcd/pkg/apis/meta v0.19.0 // indirect
	github.com/fluxcd/source-controller/api v0.35.1 // indirect
